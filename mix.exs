defmodule ExUnitJSON.MixProject do
  ...
  defp package do
    [
      ...
      files: ~w(lib .formatter.exs .version mix.exs README.md CHANGELOG.md LICENSE)
    ]
  end
  ...
  defp docs do
    [
      main: "readme",
      # AGENTS.md excluded for the same reason it is absent from `files` above:
      # publishing it puts the maintainer's global rules on hexdocs.pm.
      extras: ["README.md"],
